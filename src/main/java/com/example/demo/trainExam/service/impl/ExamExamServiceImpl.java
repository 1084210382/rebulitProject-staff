...
import com.example.demo.trainExam.dao.ExamExamMapper;
import com.example.demo.trainExam.dao.ExamSubjectMapper;
...
public class ExamExamServiceImpl implements ExamExamService {
    ...
    @Override
    public List<ExamCaExamParam> getWorkTypeExamList() {
        //User
        List<ExamCaExam> examCaExamList = examCaExamMapper.getByCaId(UserSession.getUserId());
        int workType = 0;
        List<ExamCaExamParam> examExamList = examExamMapper.getByWorkType(workType);
